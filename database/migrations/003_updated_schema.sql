...
-- Note: Using VARCHAR(36) for UUIDs instead of PostgreSQL UUID type
-- UUIDs are generated by the application using Go's github.com/google/uuid package
...
CREATE TABLE IF NOT EXISTS payments (
    ...
    payment_method_wallet_id VARCHAR(36),
...
CREATE TABLE IF NOT EXISTS wallet_movements (
    ...
    amount BIGINT NOT NULL CHECK (amount > 0),
    currency VARCHAR(3) NOT NULL,
    transaction_id VARCHAR(36) REFERENCES wallet_transactions(id),
    description TEXT,
    reference TEXT NOT NULL,
    created_at TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT NOW(),
    updated_at TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT NOW(),
